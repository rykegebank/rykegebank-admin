...
class AuthCommand extends Command {
    ...
    protected function exportBackend() {
        ...
        $controller = app_path('Http/Controllers/BranchStaffController.php');

        if (file_exists($controller) && !$this->option('force')) {
            if ($this->confirm("The [BranchStaffController.php] file already exists. Do you want to replace it?")) {
    ...
    /**
     * Compiles the "BranchStaffController" stub.
     *
     * @return string
     */
    protected function compileControllerStub() {
        return str_replace(
            ...
            file_get_contents(__DIR__ . '/Auth/stubs/controllers/BranchStaffController.stub')
        );
    }
